...
function createModel()
	...
	classifier.modules[3] = nn.SpatialAveragePooling(fc_inputMapSize[2],fc_inputMapSize[3],1,1):ceil()
	...
	-- Latent Z
	latent_input = nn.ConcatTable():add(nn.Linear(fc_size,latent_size)):add(nn.Linear(fc_size,latent_size))
	z_mean,z_log_square_var = latent_input(nn.View(fc_size)(encoderFC)):split(2)
